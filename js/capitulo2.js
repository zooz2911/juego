...
const questions = [
    ...
    },
    {
        ...
        correct: 2,
        explanation: 'Se unió después de leer un libro de Himes.'
    },
    {
        id: 78,
        level: 'dificil',
...
function showFinalResults() {
    ...
    switch(currentLevel) {
        ...
        case 'medio':
            ...
            break;
        case 'dificil':
            levelMessage = 'Nivel Difícil dominado. ¡Eres un experto en los Heraldos!';
            break;
    }
    
    if (percentage >= 90) message = '¡Excelente! Conoces perfectamente a los Heraldos del Advenimiento.';
    else if (percentage >= 70) message = '¡Muy bien! Tienes un buen conocimiento del capítulo.';
